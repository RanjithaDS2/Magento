...
public class TC004_LoginDDT extends BaseClass {
	...
	public void verify_loginDDT(String email, String password, String exp) {
		...
		try {
			...
			/*
			 * waitForElementToBeVisible(login.welcometext, 10); boolean
			 * isdisplayedofWelcomeText=login.isWelcomeTextDisplayed();
			 ...
			 * 
			 * 
			 * //boolean isdisplayedofWelcomeText=login.isWelcomeTextDisplayed(); //boolean
			 * createAccountDiplay=login.isCreateAccountOptionDisplayed();
			 * 
			 * 
			 * boolean isdisplayedofLogoutText=login.isLogoutDisplayed();
			 * System.out.println(isdisplayedofLogoutText);
			 * Assert.assertTrue(isdisplayedofLogoutText,
			 ...
			 * login.clickWelcomeText(); login.clickLogoutButton();
			...
			/*
			 * if(exp.equalsIgnoreCase("Invalid")) { if(isdisplayedofLogoutText==false) {
			 * //login.clickLogoutButton(); Assert.assertTrue(true); }
			 * 
			 * }
			 */
